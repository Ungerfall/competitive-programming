...
""";
	...
	public static class Scanner
	{
		...
		public static long Long() => long.Parse(Console.ReadLine()?.Trim() ?? throw new ArgumentNullException());
		public static (int, int) IntInt()
		{
			int[] line = Console.ReadLine()?.Trim()?.Split()?.Select(int.Parse)?.ToArray() ?? throw new ArgumentNullException();
		...
		public static T[] Array<T>() => (Console.ReadLine() ?? throw new ArgumentNullException()).Trim()
