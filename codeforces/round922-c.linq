...
""";
			...
			{
				var (a, b, r) = Scanner.LongLongLong();
				long mid = checked((a + b) / 2);
				if (mid >= 0 && mid <= r)
				{
					Console.WriteLine(Math.Abs((a ^ mid) - (b ^ mid)));
				}
				else
				{
					Console.WriteLine("ANOTEHR");
				}
			}
		}
	}
	...
	public static class Scanner
	{
		...
		public static (long, long, long) LongLongLong()
		{
